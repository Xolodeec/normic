...
$(document).ready(function (){
    ...
    $('.resizable').resizable({
        ...
        stop: function (event, ui){
            ...
            $('.modal-resizable').attr('id', ui.element.attr('id'));

            return $('.modal-resizable').modal('show');
    ...
    $('.task').dblclick(function (){
        console.log(123);
        return BX24.openPath('/workgroups/group/' + $(this).attr('group-id') + '/tasks/task/view/' + $(this).attr('id') + '/');
    })
